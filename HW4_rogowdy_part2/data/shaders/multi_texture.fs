...
void main(void)                                                   
{
    ...
    vec4 tex_color_light2 =  texture(texture_midground, pass_TexCoord);
    ...
    if(texture_blend == 0)
    {
        color = 0.1 * pass_Color + tex_color + tex_color_light + tex_color_light2 ;
    }
    else if(texture_blend == 1)
    {
        color = tex_color * tex_color_light * tex_color_light2;
    }
    else if(texture_blend == 2)
    {
        color = (tex_color_light.g)*tex_color ;
    }
	else if(texture_blend == 3)
    {
        color = (tex_color_light.r)*tex_color * tex_color_light2 ;
    }
    else
    {
