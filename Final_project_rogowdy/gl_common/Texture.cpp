...
string  GLTextureThree::_glsl_names[4] = { "texture_background", "texture_foreground", "texture_midground", "texture_blend" };
//note
#endif
...
@return int - the texture id when the texture was sucessfully loaded.
*/
int GLTextureThree::loadAndCreateTextures(string path_and_file_texture_1, string path_and_file_texture_2, string path_and_file_texture_3)
{
...
@return true, when a new mode was set, false when current and new mode are equal
*/
bool GLTextureThree::setTextureBlendMode(int mode)
{
...
*/
//virtual
bool GLTextureThree::addVariablesToProgram(GLuint program, int variable_index)
{
	if (program == -1)return false; // no program exits
...
*/
//virtual
bool GLTextureThree::dirty(GLuint program)
{
	// enable the program
	glUseProgram(program);
