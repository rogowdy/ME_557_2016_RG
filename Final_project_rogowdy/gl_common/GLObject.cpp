...
{
	g_viewMatrix = glm::lookAt(translation, glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
...
GLObject::GLObject()
{
    ...
    g_viewMatrix = glm::lookAt(glm::vec3(100.0f, 100.0f, 2.5f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    g_invViewMatrix = glm::inverse(g_viewMatrix);
...
*/
void GLObject::interpolateMat(void)
{
...
*/
void GLObject::enableInterpolation(bool enable)
{
