...
vec3 colortest = vec3(0.0, 0.5, 0.0);
...
vec4 useLight(Light light, vec4 surfacePostion, vec4 normal_transformed, vec3 normal, Material material )
{
    ...
    vec3 out_diffuse_color = material.diffuse  * diffuse_coefficient * colortest;
    
    
    // Ambient color
    vec3 out_ambient_color = material.ambient * colortest;
    ...
    vec3 out_specular_color = material.specular * specular_coefficient * colortest;
